...
<head>
    <title>Mitsuvnautoparts - Đăng ký thành viên</title>
...
<div class="header-container">
    ...
    <div class="header-top">
        <div class="h-item-left">
            <span>Hotline Ms.Hà: <span class="PhomeRed"><span id="ctl00_HeaderTop1_lblmobile">0942 399 366</span></span> | Email: lienhe@mitsuvnautoparts.com
                | Yahoo! </span>
        </div>
                ...
                <div class="main-item-2">
                	<div class="box-search">
                        ...
                        <form name="form_search" action="<?php echo base_url(); ?>tim-kiem" method="get">
                                        ...
                                        <span class="bg-txt-s">
                                            <input name="key_search" type="text" id="key_search" class="txtKeysearch AutocompleteText TextSearch" value="Nhập từ khóa tìm kiếm!" onblur="if (this.value == & #39; & #39; ) this.value = & #39; Nhập từ khóa tìm kiếm! & #39;" onfocus="if (this.value == & #39; Nhập từ khóa tìm kiếm! & #39; ) this.value = & #39; & #39;" />
                                        </span>
                                        <span class="bg-btn-s">
...
<script type="text/javascript">
//<![CDATA[
Sys.WebForms.PageRequestManager._initialize('ctl00$cph1$ScriptManager12', 'aspnetForm', ['tctl00$cph1$CustomerRegister1sdg$UpdatePanel1','','tctl00$cph1$CustomerRegister1sdg$CaptchaImage1$UpdatePanel1',''], ['ctl00$cph1$CustomerRegister1sdg$CaptchaImage1$ibtnChange',''], [], 90, 'ctl00');
//]]>
</script>

<div class="Home-layout main-login">
    
<div class="login-left">
    <h1>
        Mitsuvnautoparts<b> - THẾ GIỚI PHỤ TÙNG Ô TÔ NHẬP KHẨU-DẦU NHỚT PHỤ GIA Ô TÔ</b></h1>
    <h2>
        Chúng tôi cung cấp những sản phẩm tốt nhất, giá thành hợp lý, phục vụ uy tín, nhiệt
        tình và chu đáo.</h2>
    <h3>
        Mua hàng online<br />
        <i>Đơn giản - Tin cậy - Nhanh chóng - Giao hàng tận nơi</i></h3>
    <h4>
        Bình luận sản phẩm<br />
        <i>Cho phép tương tác trực quan, đơn giản, nhanh chóng. Bình luận sản phẩm yêu thích,
            tin tức và hỏi đáp.</i></h4>
    <h5>
        Tin tức cập nhật<br />
        <i>Các tin tức liên quan đến khuyến mại, sản phẩm mới, hoạt động của công ty ...</i></h5>
    <h6>
        Thông tin thêm: <a href="/Huong-dan-mua-hang-lvn-Help-c56677212-d92136396.aspx">Chính
            sách bán hàng</a>|<a href="thanh-toan-khi-nhan-hang-cod--lvn-Help-c72105907-d100790500.aspx">Đặt
                hàng và thanh toán</a>|<a href="/News.aspx">Tin tức</a>|<a href="/Question.aspx">Hỏi đáp</a></h6>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#ClickShowInfo").click(function () {
            $("#ChkInfo").slideToggle("slow");
            $("#ClickShowInfo a").removeClass();
            $("#ClickShowInfo a").addClass('changeicon');
        });

        hideAlertError();

        $('#ctl00_cph1_CustomerRegister1sdg_btnRegister').click(function () {

            var chk = true;
            // #1
            var _txt = $('#ctl00_cph1_CustomerRegister1sdg_txtEmail');
            var _PlaceError = $('.cssError1');
            if (_txt.val() != '' && _txt.val() != undefined) {
                if (!IsEmail(_txt.val())) {
                    _PlaceError.show(100);
                    _PlaceError.html('<i>* Email không đúng định dạng</i>');
                    _txt.addClass('classBGinput');
                    chk = false;
                } else {
                    _PlaceError.hide(100);
                    _txt.removeClass('classBGinput');
                }
            } else {
                _PlaceError.show(100);
                _PlaceError.html('<i>(*) Là thông tin bắt buộc phải nhập!</i>');
                _txt.addClass('classBGinput');
                chk = false;
            }
            // #2
            _txt = $('#ctl00_cph1_CustomerRegister1sdg_txtPass');
            _PlaceError = $('.cssError2');
            if (_txt.val() == '' || _txt.val() == undefined) {
                //                _PlaceError.show(100);
                //                _PlaceError.html('<i>* Thông tin bắt buộc</i>');
                _txt.addClass('classBGinput');
                chk = false;
            } else {
                _PlaceError.hide(100);
            ...
            // #3
            var _txtRePass = $('#ctl00_cph1_CustomerRegister1sdg_txtRePass');
            _PlaceError = $('.cssError3');
            if (_txt.val() != _txtRePass.val()) {
                _PlaceError.show(100);
                _PlaceError.html('<i>* Xác nhận mật khẩu không khớp</i>');
                _txtRePass.addClass('classBGinput');
                chk = false;
            } else {
                _PlaceError.hide(100);
                _txtRePass.removeClass('classBGinput');
            }

            // #4
            _txt = $('#ctl00_cph1_CustomerRegister1sdg_txtMobi');
            _PlaceError = $('.cssError4');
            if (_txt.val() == '' || _txt.val() == undefined) {
                _txt.addClass('classBGinput');
                chk = false;
            } else {
            ...
            // #5
            _txt = $('#ctl00_cph1_CustomerRegister1sdg_txtFullName');
            _PlaceError = $('.cssError5');
            if (_txt.val() == '' || _txt.val() == undefined) {
                _txt.addClass('classBGinput');
                chk = false;
            } else {
            ...
            // #6
            _txt = $('#ctl00_cph1_CustomerRegister1sdg_txtAddress');
            if (_txt.val() == '' || _txt.val() == undefined) {
                _txt.addClass('classBGinput');
                chk = false;
            } else {
...
//            }
    ...
    function hideAlertError() {
        var _cmdAlertError = $('.bg-error-infocus');
        if (_cmdAlertError.is(':visible')) {
            _cmdAlertError.delay(8000).fadeOut('slow');
        }
    }

    //send mail
    function SendMailForgotPass() {
        var FullName = $('#ctl00_cph1_CustomerRegister1sdg_txtFullName').val();
        var Email = $('#ctl00_cph1_CustomerRegister1sdg_txtEmail').val();
        var _url = '/Pages/Ajax/SendEmail_Register.ashx?timespan=' + Number(new Date()) + '&fullname=' + FullName + '&email=' + Email;
...
<div class="box-footer">
    ...
    <div class="foo-item">
        <div class="foo-wrap">
            <div id="ctl00_Footer1_Panel1" onkeypress="javascript:return WebForm_FireDefaultButton(event, &#39;ctl00_Footer1_btnSendMail&#39;)">
                ...
                <span class="foo-row foo-text-2">Đăng ký nhận Email </span><span class="foo-row foo-text-6">
                    ...
                    trình khuyến mãi </span><span class="foo-row">
                        <input name="ctl00$Footer1$txt_cusEmail" type="text" value="Nhập địa chỉ email của bạn" id="ctl00_Footer1_txt_cusEmail" class="txtEmail" onblur="if(this.value==&#39;&#39;) this.value=&#39;Nhập địa chỉ email của bạn&#39;" onfocus="if(this.value ==&#39;Nhập địa chỉ email của bạn&#39; ) this.value=&#39;&#39;" />
