                  ...
                  <div class="box-left">
                     ...
                     <div id="ctl00_cph1_Product_Filter1_UPFilter">
                        <div class="bg-filter2" id="bgfilter">
                           ...
                           <div class="divRow">
                              <select name="year" onchange="javascript:setTimeout(&#39;__doPostBack(\&#39;ctl00$cph1$Product_Filter1$ddlYear\&#39;,\&#39;\&#39;)&#39;, 0)" id="ctl00_cph1_Product_Filter1_ddlYear" class="ddlfilter">
                           ...
                           <div class="divRow">
                              <select name="manu_fac" id="ctl00_cph1_Product_Filter1_ddlManufactor" class="ddlfilter">
                                 <option selected="selected" value="0">Chọn h&#227;ng...</option>
                                 <?php 
                                 foreach($list_manufac as $manufac)
                                 {
                                 ?>
                                 <option value="<?php echo $manufac['id'] ?>"><?php echo $manufac['name']?></option>
                                 <?php } ?>
                              </select>
                           </div>
                           ...
                           <div class="divRow">
                              ...
                              <input type="submit"  value=""  class="btn-chon" />
                              </span>
                           </div>
                                </form>
                        </div>
