...
<!--end menu navibar-->
    ...
    <script type="text/javascript">
//<![CDATA[
Sys.WebForms.PageRequestManager._initialize('ctl00$cph1$ScriptManager1', 'aspnetForm', ['tctl00$cph1$StreetMap12$CaptchaImage1$UpdatePanel1',''], ['ctl00$cph1$StreetMap12$CaptchaImage1$ibtnChange',''], [], 90, 'ctl00');
//]]>
</script>
...
<div class="pn-sitemap" style="line-height: 38px;">
    <ul>
        <li><a class="lnkSiteMap" href="/">Trang chủ</a></li>
        <li><a class="lnkSiteMap lnkUnderline" href="">Liên hệ</a></li>
    </ul>
    <div class="clr">
    </div>
</div>
        ...
        <div class="address-left">
            ...
            <ul>
                <li class="active-contact">
                    <h2>
                        <i></i>Địa chỉ liên hệ</h2>
                    <b>mitsuvnautoparts.com – Thế giới phụ tùng ô tô nhập khẩu - dầu nhớt phụ gia ô tô</b> <span>263 Âu Dương Lân - Phường 2 - Quận 8 - TPHCM</span>
                </li>
                <li class="active-contact">
                    <h2>
                        <i></i>Hỗ trợ điện thoại</h2>
                    <span style="padding-bottom: 6px">Điện thoại: <font color="#ff8a01" size="13px"><strong>
                       082.218.9762</strong></font></span>
                    <b>Thời gian làm việc:</b> <span>Từ <b>8h30 đến 17h30 </b> từ thứ 2 đến thứ 7</span> </li>
                <li class="active-contact">
                    <h2>
                        <i></i>Hỗ trợ trực tuyến</h2>
                    <span>Hỗ trợ khách hàng: <a href="mailto:lienhe@mitsuvnautoparts.com">lienhe@mitsuvnautoparts.com</a></span>
                    <span>Liên hệ: <a href="mailto:lienhe@mitsuvnautoparts.com">lienhe@mitsuvnautoparts.com</a></span>
                    <span>Website: <a href="http://www.mitsuvnautoparts.com">www.mitsuvnautoparts.com</a></span>
                </li>
            </ul>
