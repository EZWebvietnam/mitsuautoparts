               ...
               <form action="<?php echo base_url();?>admin/productadmin/deletes" method="post" accept-charset="utf-8" id="admindata_khoahoc">
                  ...
                  <table class="admindata">
                     ...
                     <tr class="row1 ">
                        ...
                        <td align="center"><a class="grouped_elements" href="<?php echo base_url();?>admin/productadmin/edit/<?php echo $product_ref['id']?>" title="Sửa"><img width="16" height="16" src="<?php echo base_url();?>template/ezwebvietnam/admin_cp/icon/edit.png"></a>
                            <a class="grouped_elements" href="<?php echo base_url();?>admin/productadmin/view/<?php echo $product_ref['id']?>" title="Xem chi tiết"><img width="16" height="16" src="<?php echo base_url();?>template/ezwebvietnam/admin_cp/icon/view.png"></a>
                            
                           <a class="delete_record" href="<?php echo base_url();?>admin/productadmin/delete/<?php echo $product_ref['id']?>" title="Xóa"><img src="<?php echo base_url();?>template/ezwebvietnam/admin_cp/icon/del.png"></a>        
