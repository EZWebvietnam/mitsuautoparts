...
<div class="m-pop">
    ...
    <form action="<?php echo base_url(); ?>admin/productadmin/edit/<?php echo $detail_product[0]['id'] ?>" method="post" accept-charset="utf-8" id="adminform"><input type="hidden" name="id" value="74">
        <table class="form" style="width: 1200px;">
			...
			<tr>
                ...
                <td colspan="3">
					...
					{
						if($detail_product[0]['id_cate']==$cate['id'])
						{
					?>
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <input id="userfile" name="userfile" type="button" class="bt100" value="Upload" onClick="fileUpload(this.form,'<?php echo base_url();?>upload/do_upload','upload','<?php echo base_url(); ?>admin/productadmin/edit/<?php echo $detail_product[0]['id'] ?>'); return false;">
                   <div id="upload"></div>
        ...
        $("#adminform").validate({
            ...
            , submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    data: {title:$('#title').val(),category:$('#category').val(),cost:$('#cost').val(),file:$('#file').val(),content:content},
